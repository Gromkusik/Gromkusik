...
public class PageInstalment {
    WebDriver driver;
    By Number = By.xpath("//*[@id='score-instalment']");
    By Sum = By.id("instalment-sum");
    By Email = By.id("instalment-email");
    By Button = By.xpath("//form[@id='pay-instalment']//button");

    //конструктор
    public PageInstalment(WebDriver driver) {
        this.driver = driver;
    }
